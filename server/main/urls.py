...
from .views import index, SignUpView, SignInView, LectureViewSet, CheckStudentPresence, GetAllPresentStudents, MarkStudentPresentView, ChatView
...
# Catch-all route should be last to prevent interference with static file serving
urlpatterns += [
